...
VARIETIES = [
    dict(name='IHCAFE 90', family='Catimor (Caturra × Timor Hybrid)', released='1990s', year=1990, year_status='PRESS',
         resistance='Still resistant in April 2018 (IHCAFE, 4 new rust strains found); not listed as resistant in USDA 2020 (16 new strains, April 2019)',
         broke=None, src='GAIN 2013 ("The varieties developed were the IHCAFE 90 and Lempira"); GAIN 2018; GAIN 2020',
         note='Release year not in a document we could open; the name points to 1990.', status='USDA'),
    dict(name='Lempira', family='Catimor (Timor Hybrid 832/1 × Caturra)', released='1997–98', year=1998, year_status='PRESS',
         resistance='Resistance loss confirmed by IHCAFE in April 2017; rust on 3 % of Lempira plants', broke=2017,
         src='GAIN 2017 ("In April 2017, IHCAFE confirmed the loss of resistance of the Lempira variety"; "rust was present on three percent of Lempira variety plants")',
         note='Release 1997/98 and the 56 % share of sampled farms (IHCAFE bulletin No 8, Oct 2017) are search snippets only.', status='USDA'),
    dict(name='Parainema', family='Sarchimor T-5296 (Villa Sarchí × Timor Hybrid)', released='2004', year=2004, year_status='PRESS',
         resistance='Still resistant per IHCAFE (USDA 2018, 2020, 2021); USDA 2025–26: area growth "driven by the introduction of the Parainema variety"',
         broke=None, src='GAIN 2014 (third IHCAFE variety listed); GAIN 2018; GAIN 2020; GAIN 2025', note='Release year 2004 is a search snippet.', status='USDA'),
    dict(name='Ihcatú 75, Anacafé 14 SHN, Obatá SHN', family='3 varieties presented by IHCAFE', released='Feb 2024', year=2024, year_status='PRESS',
         resistance='Presented as rust resistant, productive; seed for at least 1 500 manzanas in 2024', broke=None,
         src='El Heraldo, "Honduras dispone de tres nuevas variedades de café" (2024)', note='Search snippet only; first releases about 20 years after Parainema.', status='PRESS'),
    dict(name='4 more in the pipeline', family='IHCAFE research centres', released='announced', year=2025, year_status='PRESS',
         resistance='"at least 4 more rust-resistant varieties" being prepared', broke=None,
         src='La Prensa, "Ihcafé se prepara para liberar 4 variedades más resistentes a roya"', note='Search snippet only.', status='PRESS'),
]
